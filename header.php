...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="//cdn.bootcss.com/normalize/4.1.1/normalize.min.css">
    ...
    <link rel="shortcut icon" href="<?php $this->options->themeUrl('img/favicon.ico'); ?>" mce_href="<?php $this->options->themeUrl('img/favicon.ico'); ?>" type="image/x-icon">
        ...
        <div class="col-group">
            <div class="site-name">                
                <a id="logo" href="<?php $this->options->siteUrl(); ?>">
                    <img src="<?php $this->options->themeUrl('img/profile.jpg'); ?>" class="logo-pic" alt="<?php $this->title() ?>" />
                </a>
                <br>
